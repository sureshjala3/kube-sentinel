...
export function RbacAssessmentTab({
  namespace,
  kind,
  name,
}: RbacAssessmentTabProps) {
      ...
      <div className="p-6">
        ...
        >
          ...
          <AlertDescription className="text-blue-700 dark:text-blue-400 ml-2 mt-2">
            <p className="mb-4">
              RBAC assessment scanning requires the Trivy Operator to be
  ...
  if (isLoading) {
    return (
      <div className="p-6 text-center text-muted-foreground">
        Loading RBAC assessment reports...
      </div>
    )
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center border rounded-lg bg-muted/30">
        ...
        <p className="text-sm text-muted-foreground mt-2 max-w-sm">
          Trivy Operator hasn't scanned this resource yet, or no issues were
          found.
        </p>
      </div>
    )
  ...
  const allChecks = reports.items.flatMap(
    (report: RbacAssessmentReport | ClusterRbacAssessmentReport) =>
