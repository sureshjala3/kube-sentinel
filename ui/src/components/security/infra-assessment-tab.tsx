...
export function InfraAssessmentTab({
      ...
      <div className="p-6">
        ...
        >
          ...
          <AlertDescription className="text-blue-700 dark:text-blue-400 ml-2 mt-2">
            <p className="mb-4">
              Infrastructure assessment scanning requires the Trivy Operator to
  ...
  if (isLoading) {
    return (
      <div className="p-6 text-center text-muted-foreground">
        Loading infrastructure assessment reports...
      </div>
    )
  }
  ...
  const allChecks = reports.items.flatMap(
    (report: InfraAssessmentReport | ClusterInfraAssessmentReport) =>
